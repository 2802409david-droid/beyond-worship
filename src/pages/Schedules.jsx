...
function Schedules({ onNavigate, userRole }) {
  ...
  return (
    <div className="page-container" style={{ maxWidth: "800px", margin: "0 auto", padding: "40px 20px" }}>
      ...
      <div className="schedules-header" style={{ marginBottom: "24px" }}>
        ...
        <p style={{ color: "#94a3b8", margin: "0 0 16px 0" }}>Revisa los repertorios y asignaciones para cada servicio.</p>
        
        {/* Solo el admin / director ve el botón de programar */}
        {userRole === "admin" && (
          <button
            type="button"
            onClick={() => {
      ...
      {schedulesList.length === 0 ? (
        <div style={{ textAlign: "center", padding: "60px 0", background: "rgba(30, 41, 59, 0.4)", borderRadius: "16px", border: "1px solid rgba(255,255,255,0.05)" }}>
          ...
          <p style={{ color: "#94a3b8" }}>Aún no se han creado planificaciones.</p>
        </div>
      ) : (
