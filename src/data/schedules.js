...
function Schedules({ onNavigate }) {
  ...
  useEffect(() => {
    // Nos suscribimos a Firebase en tiempo real para obtener los cultos
  ...
  return (
    <div className="page-container" style={{ maxWidth: "800px", margin: "0 auto", padding: "40px 20px" }}>
      ...
      <div className="schedules-header" style={{ marginBottom: "24px" }}>
        ...
        <p style={{ color: "#94a3b8", margin: 0 }}>Organiza los repertorios y asigna músicos para cada servicio.</p>
        
        {/* BOTÓN PARA CREAR NUEVO CULTO */}
        <button
          type="button"
          onClick={() => onNavigate && onNavigate("new-schedule")}
          style={{
            marginTop: "16px",
            background: "#38bdf8",
            color: "#0f172a",
